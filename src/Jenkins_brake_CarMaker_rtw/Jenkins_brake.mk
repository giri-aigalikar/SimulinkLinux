...
MATLAB_ROOT	= $(subst \,/,/home/giri/Documents/Matlab21bSetup)
ALT_MATLAB_ROOT	= $(subst \,/,/home/giri/Documents/Matlab21bSetup)
MAKECMD         = "/opt/ipg/carmaker/linux64-11.0.1/bin/cmmake"
HOST            = ANY
BUILD           = yes
...
MODEL		= Jenkins_brake
WRAPPER		= Jenkins_brake_wrap
CLASS		= Brake
DESCRIPTION	= "jenkins_brake"
MAINMODEL	= ""
PARAMID		= 1
SYMBOLS		= ""
...
INC_CFLAGS	+= -I$(subst \,/,"/home/giri/Documents/JenkinTest2/src")
INC_CFLAGS	+= -I$(subst \,/,"/home/giri/Documents/JenkinTest2/src/Jenkins_brake_CarMaker_rtw")
INC_CFLAGS	+= -I$(subst \,/,"/home/giri/Documents/JenkinTest2/src_cm4sl")
