...
include /opt/ipg/carmaker/linux64-12.0.1/include/MakeDefs.linux64

# Matlab version in use.
MATSUPP_MATVER  = R2021a
MATSUPP_NUMVER  = 91000
...
MATLAB_ROOT	= $(subst \,/,/home/giri/Documents/MATLAB)
ALT_MATLAB_ROOT	= $(subst \,/,/home/giri/Documents/MATLAB)
MAKECMD         = "/opt/ipg/carmaker/linux64-12.0.1/bin/cmmake"
HOST            = ANY
BUILD           = yes
...
MODEL		= VehControl
WRAPPER		= VehControl_wrap
CLASS		= VehicleControl
DESCRIPTION	= "VehControl"
MAINMODEL	= ""
PARAMID		= 1
SYMBOLS		= ""
...
MODELREF_LINK_RSPFILE     = VehControl_ref.rsp
...
#OPT_CFLAGS	= -g
USR_CFLAGS	=  -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL 
...
INC_CFLAGS	+= -I$(subst \,/,"/home/giri/Documents/Demo_pipeline/JenkinTest/src")
INC_CFLAGS	+= -I$(subst \,/,"/home/giri/Documents/Demo_pipeline/JenkinTest/src/VehControl_CarMaker_rtw")
...
ifeq ($(filter linux64 win32 win64 xeno lvrt nilrt ds1006 dsrt, $(ARCH)), )
	...
	$Q $(CMPU) mklib -a $(ARCH) -m $(MODEL) -k $(SYMBOLS) \
		-o $@ $(OBJS) @$(MODELREF_LINK_RSPFILE) $(LIBS) \
